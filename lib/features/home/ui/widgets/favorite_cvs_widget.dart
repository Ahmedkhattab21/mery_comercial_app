...
class FavoriteCvsWidget extends StatelessWidget {
  const FavoriteCvsWidget({super.key});
    ...
    return BlocBuilder<HomeCubit, HomeState>(
      ...
      builder: (context, state) {
        if (state is OnGetFavoritesLoadingState &&
            HomeCubit.get(context).favorites.isEmpty) {
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                if (HomeCubit.get(context).favorites.isNotEmpty)
                  Text(
                    'العمالة المميزة',
                ...
                if (HomeCubit.get(context).favorites.isNotEmpty)
                  verticalSpace(12),
                Row(
                  children: HomeCubit.get(context).favorites
                      .map(
