...
class RegisterNationalIdWidget extends StatelessWidget {
  const RegisterNationalIdWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return AppTextFormField(
      ...
      controller: RegisterCubit.get(context).nationalIDController,
