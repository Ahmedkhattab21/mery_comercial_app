      ...
      body: SafeArea(
        child: BlocBuilder<NotificationsCubit, NotificationsState>(
          buildWhen: (previous, current) {
            return current is OnGetNotificationsLoadingState ||
                current is OnGetNotificationsSuccessState ||
                current is OnGetNotificationsErrorState ||
                current is OnGetNotificationsCatchErrorState;
          },
          builder: (context, state) {
            if (state is OnGetNotificationsLoadingState &&
                NotificationsCubit.get(context).notifications.isEmpty) {
              return Column(
